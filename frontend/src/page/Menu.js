    ...
    <div className='p-2 md:p-4'>
      <div className='w-full max-w-3xl m-auto md:flex bg-white'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <p className='font-bold md:text-2xl'><span className='text-red-500'>US$</span><span>{productDisplay.price}</span></p>
          <div className="flex gap-3">
            <button onClick={handleAddCartProduct} className='bg-red-500 py-1 mt-2 rounded hover:bg-red-600 min-w-[100px]'>Add to Cart</button>
          </div>
          <div>
